...
job_name = "refinedet_resnext26_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNeXt/coco/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNeXt/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNeXt/coco/{}".format(job_name)
...
pretrain_model = "models/ResNeXt/resnext26-32x4d-priv.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['resx4_elewise', 'resx6_elewise', 'resx8_elewise', 'resx9_elewise']
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [1120000, 1440000, 1600000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 1600000,
...
ResNeXt26Body(net, from_layer='data', use_final_pool=False)
