...
job_name = "refinedet_resnext50_{}".format(resize)
...
pretrain_model = "models/ResNeXt/resnext50-32x4d.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['resx7_elewise', 'resx13_elewise', 'resx16_elewise', 'resx17_elewise']
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [960000, 1280000, 1450000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 1450000,
...
ResNeXt50Body(net, from_layer='data', use_final_pool=False)
