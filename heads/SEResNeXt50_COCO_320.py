...
job_name = "refinedet_seresnext50_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/SEResNeXt50/coco/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/SEResNeXt50/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/SEResNeXt50/coco/{}".format(job_name)
...
pretrain_model = "models/SEResNeXt50/SE-ResNeXt-50.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['conv3_4', 'conv4_6', 'conv5_3', 'conv6']
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [373000, 480000, 533000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 533000,
...
SEResNeXt50Body(net, from_layer='data', use_final_pool=False)
...
net[name] = L.MultiBoxLoss(*mbox_layers_odm, multibox_loss_param=multibox_loss_param,
        ...
        #propagate_down=[True, True, True, True, True, True])
