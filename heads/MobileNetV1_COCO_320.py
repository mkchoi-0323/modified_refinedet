...
job_name = "refinedet_mobilenetv1_{}".format(resize)
...
arm_source_layers = ['relu3_2/sep', 'relu4_2/sep', 'relu6/sep', 'relu7/sep']
...
MobileNetV1Body(net, from_layer='data', use_final_pool=False)
...
print("Finish generation deploy!")
sys.exit(1)
