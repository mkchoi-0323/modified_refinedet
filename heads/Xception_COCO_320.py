...
job_name = "refinedet_xception_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/Xception/coco/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/Xception/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/Xception/coco/{}".format(job_name)
...
pretrain_model = "models/Xception/xception.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['xception2_elewise', 'xception11_elewise', 'conv4_2', 'xception13_elewise']
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [680000, 800000, 880000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 880000,
...
XceptionBody(net, from_layer='data', use_final_pool=False)
