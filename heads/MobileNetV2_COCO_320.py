...
job_name = "refinedet_mobilenetv2_{}".format(resize)
...
pretrain_model = "models/MobileNet/mobilenet_v2.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['block_4_6', 'block_5_2', 'relu6_4', 'conv7/linear']
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [450000, 580000, 640000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 640000,
...
MobileNetV2Body(net, from_layer='data', use_final_pool=False)
...
print("Finishi generating deploy!")
sys.exit(1)
