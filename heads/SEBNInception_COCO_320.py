...
def AddExtraLayers(net, arm_source_layers=[], use_batchnorm=True, **bn_param):
    use_relu = True
...
job_name = "refinedet_sebninception_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "coco_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/SEBNInception/coco/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/SEBNInception/coco/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/SEBNInception/coco/{}".format(job_name)
...
pretrain_model = "models/SEBNInception/SE-BN-Inception.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['inception_3b_scale', 'inception_4d_scale', 'inception_5b_scale', 'inception_6_scale']
...
solver_param = {
    ...
    'weight_decay': 0.0005,
    'lr_policy': "multistep",
    'stepvalue': [220000, 280000, 320000],
    'gamma': 0.1,
    'momentum': 0.9,
    'iter_size': iter_size,
    'max_iter': 320000,
...
SEBNInceptionBody(net, from_layer='data', use_final_pool=False)
...
#for l in vars(net).items()[0][1].items():
#    print(l[0])
#sys.exit(1)
...
print("Finish generating deploy!")
sys.exit(1)
